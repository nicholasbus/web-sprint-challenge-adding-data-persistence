...
- Relational databases are used to store data in tables that relate to eachother. SQL is used to query the database, insert tables and data, and delete tables and data.

2. Why do tables need a Primary Key?

- Tables need a primary key in order to easily identify each record.
...
- In order to have a many to many relationship between two tables, we need a junction table which holds the primary key from both tables that are related to each other.
